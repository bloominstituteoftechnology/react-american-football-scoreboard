    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__fieldGoal" onClick={homeReset}>Home Reset Score</button>
        ...
        <div className="awayButtons">
          ...
          <button className="awayButtons__fieldGoal"onClick={awayReset}>Away Reset Score</button>
