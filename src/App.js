    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__fieldGoal" onClick={hGoal}>Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={aTouchdown}>Away Touchdown</button>
          <button className="awayButtons__fieldGoal" onClick={aGoal}>Away Field Goal</button>
        </div>
      </section>
    </div>
  );
