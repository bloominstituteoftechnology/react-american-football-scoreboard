...
function App() {
  ...
  //adding useStates for home and away and set its initial value state to 0
...
{/* changed scores for home and away with the home and away states */}
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          {/* added onClick with assignment operators adding points to home and away based on field goal or touchdown. I take the setStates for home and away and change its current home and away states into the new score */}
